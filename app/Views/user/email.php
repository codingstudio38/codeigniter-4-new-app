            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Send New Email</h1> 
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Create Email</h6>
                                </div>
 <?php $response = session()->getFlashdata('response'); if ($response !== NULL) : ?>
...
<form method="post" name="postform" action="sendemails" enctype="multipart/form-data">
	<?= csrf_field(); ?>

	<div class="form-group row">
  <label for="publicinfo" class="col-4 col-form-label">Name</label> 
  <div class="col-8">
    <input type="text" id="Name" name="Name" placeholder="Name"  class="form-control" value="<?=old('Name') ?>" <?php if(!$errors==null){ if(isset($errors['Name'])){echo $cssinvalid;} else { echo $cssvalid;}} ?>   >
...
<div class="form-group row">
  <label for="publicinfo" class="col-4 col-form-label">Email</label> 
  <div class="col-8">
    <input type="email" id="Email" name="Email" placeholder="Email"  class="form-control" value="<?=old('Email') ?>" <?php if(!$errors==null){ if(isset($errors['Email'])){echo $cssinvalid;} else { echo $cssvalid;}} ?>   >
...
<div class="form-group row">
  <label for="publicinfo" class="col-4 col-form-label">Subject</label> 
  <div class="col-8">
    <input type="text" id="Subject" name="Subject" placeholder="Subject"  class="form-control" value="<?=old('Subject') ?>" <?php if(!$errors==null){ if(isset($errors['Subject'])){echo $cssinvalid;} else { echo $cssvalid;}} ?>   >
...
<div class="form-group row">
  <label for="publicinfo" class="col-4 col-form-label">Message</label> 
  <div class="col-8">
    <textarea id="Message" name="Message" placeholder="Message"  cols="40" rows="4" class="form-control" <?php if(!$errors==null){ if(isset($errors['Message'])){echo $cssinvalid;} else { echo $cssvalid;}} ?>><?=old('Message') ?></textarea>
