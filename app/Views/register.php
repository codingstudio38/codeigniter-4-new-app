                ...
                <div class="row align-items-center justify-content-xl-between g-4 g-md-5">
                    ...
                    <div
                        ...
                        <h6
                            ...
                            Get started with Eduport</h6>
                        <!-- Title -->
                        <h1 class="mb-4 display-5">Start With Us..
                            <span class="position-relative d-inline-block">Please Create An Account..
                                <!-- SVG decoration -->
                                <span
...
$cssinvalid = "style='border: 2px solid #dc3545 !important;
 ...
 ?>
                    ...
                    <div class="col-lg-5 col-xl-6 text-center position-relative">
                        ...
                        <div class="alert alert-success"><?php echo session()->getFlashdata('successMsg') ?></div>
                        <?php endif ; ?>
                        <?php if(session()->getFlashdata('errorsMsg') != null) : ?>
                        <div class="alert alert-danger"><?php echo session()->getFlashdata('errorsMsg') ?></div>
                        <?php endif ; ?>

                        <form method="post" action="register" method="rgform" id="rgform">
                            <?= csrf_field() ?>
                            <div class="form-outline mb-4">
                                <input class="form-control" type="text" name="Name" value="<?=old('Name') ?>"
                                    placeholder="Full Name"
                                    <?php if(!$errors==null){ if(isset($errors['Name'])){echo $cssinvalid;} else { echo $cssvalid;}} ?>>
                            ...
                            <div class="form-outline mb-4">
                                <input class="form-control" type="email" name="Email_Id" value="<?=old('Email_Id') ?>"
                                    placeholder="Email Id"
                                    <?php if(!$errors==null){ if(isset($errors['Email_Id'])){echo $cssinvalid;} else { echo $cssvalid;}} ?>>
                            ...
                            <div class="form-outline mb-4">
                                <input class="form-control" type="text" name="Phone_No" value="<?=old('Phone_No') ?>"
                                    ...
                                    maxlength="10"
                                    <?php if(!$errors==null){ if(isset($errors['Phone_No'])){echo $cssinvalid;} else { echo $cssvalid;}} ?>>
                                <?php if(isset($errors['Phone_No'])){ ?>
                                <div class="error"><?= $errors['Phone_No']; ?></div>
                                <?php }  ?>
                            </div>
                            <div class="form-outline mb-4">
                                <input class="form-control" type="password" name="Password"
                                    value="<?=old('Password') ?>" placeholder="Password"
                                    <?php if(!$errors==null){ if(isset($errors['Password'])){echo $cssinvalid;} else { echo $cssvalid;}} ?>>
                            ...
                            <div class="form-outline mb-4">
                                <input class="form-control" type="password" name="Confirm_Password"
                                    ...
                                    <?php if(!$errors==null){ if(isset($errors['Confirm_Password'])){echo $cssinvalid;} else { echo $cssvalid;}} ?>>
                                <?php if(isset($errors['Confirm_Password'])){ ?>
                                <div class="error"><?= $errors['Confirm_Password']; ?></div>
                                <?php }  ?>
                            </div>
                            <div class="form-outline mb-4">
                                <input type="submit" style="width: 100%;" name="Register" value="Register"
                                    class="btn btn-primary btn-block">
                                <a href="login" style="width: 100%;" class="btn btn-warning btn-block mb-2">Login</a>
                            </div>
                        </form>
