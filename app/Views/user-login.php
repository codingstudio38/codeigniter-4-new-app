		...
		<div class="row align-items-center justify-content-xl-between g-4 g-md-5">
			...
			<div class="col-lg-7 col-xl-5 position-relative z-index-1 text-center text-lg-start mb-2 mb-md-9 mb-xl-0">
				...
				<h1 class="mb-4 display-5">Start With Us..
					<span class="position-relative d-inline-block">Please Login..
						<!-- SVG decoration -->
    ...
    <div class="row">
      <div class="col-md-12"> 
        <div class="card my-5">
          ...
          <form  action="loginUser" method="post" class="card-body cardbody-color p-lg-5">
          	<?= csrf_field(); ?>
            <div class="text-center">
              <img src="<?= base_url(); ?>/assets/images/p.JPG" class="img-fluid profile-image-pic img-thumbnail rounded-circle my-3" width="200px" alt="profile">
            </div>

            <div class="mb-3">
              <input type="emails" class="form-control" name="Email_Id" id="emailid" value="<?=old('Email_Id') ?>" aria-describedby="emailHelp"
                placeholder="Email Id" <?php if(!$errors==null){ if(isset($errors['Email_Id'])){echo $cssinvalid;} else { echo $cssvalid;}} ?>>
